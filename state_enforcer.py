...
def generate_graph(state_model_complete, state_model_file):
    #
...
def generate_java_code(state_model_complete, package_name):
    state_model = []
    if YAML_TAG_STATES_TRANSITIONS in state_model_complete:
        state_model = state_model_complete[YAML_TAG_STATES_TRANSITIONS]
    ...
    # Header
    #
    file_name = 'StateModel.java'

    header = "// Generated by StateModelChecker (https://github.com/petrs/StateModelChecker) \n"
    header += "package {};\n".format(package_name)
    header += "\n"
    ...
    with open(file_name, "w") as file:
        ...
        value = "\n\n    private short STATE_CURRENT = STATE_UNSPECIFIED;\n\n" \
                ...
                + "        STATE_CURRENT = makeStateTransition(STATE_CURRENT, newState);\n" \
        ...
        value = "    private static short makeStateTransition(short currentState, short newState) {\n"
...
def render_state_model():
    ...
    generate_java_code(state_model, package_name)
    generate_graph(state_model, state_file)
